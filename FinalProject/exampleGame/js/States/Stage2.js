Stage2.prototype = {
	...
	create: function() {
		...
		this.map = game.add.tilemap('stage2');
		...
		this.player = new Players(game, 2200, 2700, 'slimeAll', 1, this.wallLayer);

		//Create terrain of this level
		this.createWater(14,6,1870,2255);
		this.player.resetType('noneIcon');

		//Set the portal of this level
		this.portal1 = new Portal(game,1900,2600, 'portal', 1, this.player,1, this);
		...
		this.fire1 = new BonFire(game,1750, 2700, 'bonfire', 1, this.player);
		...
		this.addBaddies(this.enemies,2000,2000);
		this.addBaddies(this.enemies,2400,2700);
		this.addBaddies(this.enemies,2450,2300);
	...
	addBaddiesB:function(group, x, y){
		var baddy = new BaddiesB(game, x, y, 'iceSprite', 1, this.player, this.wallLayer, this, 'xMove');
		game.add.existing(baddy);
		group.add(baddy);
	},
